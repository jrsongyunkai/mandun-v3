      ...
      <el-col class="box-wrap">
        <el-row>
          <span class="box-right">
            <el-col class="pointer grid-content grid-content-open tc">
              <i v-if="list.tem" class="iconfont icon-guangzhaoduchuanganqi"></i>
              <span v-if="list.tem">
                <p>{{ $t('echarts.illumination') + $t('echarts.celsius') + '：' + (list.tem[0] ? list.tem[0] + 'Lux' : '--Lux') }}</p>
                <p>{{ $t('control.upperLimit') + '：' + (list.tem[1] ? list.tem[1] + 'Lux' : '-- Lux') }}</p>
                <p>{{ $t('control.lowerLimit') + '：' + (list.tem[2] ? list.tem[2] + 'Lux' : '-- Lux') }}</p>
              </span>
            </el-col>
          </span>
        </el-row>
